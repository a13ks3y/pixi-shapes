...
export class ShapeController {
    ...
    constructor(stage : Container, shapeModel:ShapeModel) {
        ...
        this.area = this._view.draw(this._graphics, this._model.w, this._model.h, this._model.color, this._model.angle);
    ...
    update(screenHeight: number, gravity: number, deltaTime: number) {
      this._model.update(gravity, screenHeight, this._graphics.getBounds(), deltaTime);
        this.move(this._model.x, this._model.y);
    }
    dispose() {
