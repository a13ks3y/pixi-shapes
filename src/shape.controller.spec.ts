...
describe('ShapeController class', () => {    
    ...
    it('should calculate rectangle area', () => {
        const shape = new ShapeController(stageMock, new ShapeModel(0,0,2, 3, 0, 0,  ShapeType.RECT as number));
        expect(shape.area).toBe(6);
    });
    it('should calculate triangle area', () => {
        const shape = new ShapeController(stageMock, new ShapeModel(0,0, 2, 3, 0, 0, ShapeType.TRIANGLE as number));
    ...
    it('should calculate hexagone area', () => {
        const shape = new ShapeController(stageMock, new ShapeModel(0,0,32, 32, 0, 0, ShapeType.HEXAGONE as number));
